...
This is a VST and Audio Unit plugin by Tobybear (tobybear.de) and 
Bram (smartelectronix.com) with full Delphi source included!
It is available on Bram's truly excellent DSP source code page 
musicdsp.org!

* This is a Mac/C++ Audio Unit distribution put together by 
Sophia Poirier of Destroy FX / Smartelectronix.  
The plugin included in this distribution is for Mac OS X.  
The source code has been translated from Delphi to C++ by 
Sophia Poirier and Xcode 3 project files are included.  
It's actually not really a straight translation:  everything 
was rewritten to use the DfxPlugin and DFX GUI frameworks, 
and Sophia also changed a few little details here and there.

1. What does it do?
Well, as Bram puts it:  it is an "ultrafast and lofi pitchshifter",
...
Xcode 3 is what Sophia used to compile MadShifta.  Other compilers/IDEs 
for Mac OS X should work as well.
