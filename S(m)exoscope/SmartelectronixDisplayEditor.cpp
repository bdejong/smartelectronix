...
CSmartelectronixDisplayEditor::CSmartelectronixDisplayEditor(AudioEffect *effect) : AEffGUIEditor (effect)
{
...
long CSmartelectronixDisplayEditor::open (void *ptr)
{
	// !!! always call this !!!
...
void CSmartelectronixDisplayEditor::setParameter (long index, float value)
{
	...
	switch(index)
	{
		case CSmartelectronixDisplay::kDCKill		: dc->setValue(value); break;
		case CSmartelectronixDisplay::kChannel		: channelSelector->setValue(value); break;
		case CSmartelectronixDisplay::kFreeze		: freeze->setValue(value); break;
		case CSmartelectronixDisplay::kTriggerLimit 	: triggerLimit->setValue(value); break;
		case CSmartelectronixDisplay::kTriggerSpeed	: triggerSpeed->setValue(value); break;
		case CSmartelectronixDisplay::kTimeWindow	: timeWindow->setValue(value); break;
		case CSmartelectronixDisplay::kAmpWindow	: ampWindow->setValue(value); break;
		case CSmartelectronixDisplay::kSyncDraw		: syncDraw->setValue(value); break;
		case CSmartelectronixDisplay::kTriggerType	: trigger->setValue(value); break;
		case CSmartelectronixDisplay::kTriggerLevel	: triggerLevel->setValue(value); break;
		default										: break;
	}
	...
	switch(index)
	{
		case CSmartelectronixDisplay::kTriggerLimit 	: threshLabel->setLabel(temp); break;
		case CSmartelectronixDisplay::kTriggerSpeed	: trigLabel->setLabel(temp); break;
		case CSmartelectronixDisplay::kTimeWindow	: timeLabel->setLabel(temp); break;
		case CSmartelectronixDisplay::kAmpWindow	: ampLabel->setLabel(temp); break;
	}

	postUpdate();
}

void CSmartelectronixDisplayEditor::valueChanged (CDrawContext* context, CControl* control)
{
