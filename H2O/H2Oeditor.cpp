...
H2Oeditor::H2Oeditor(AudioEffect* effect)
    : AEffGUIEditor(effect)
{
    attack = release = ingain = outgain = amount = 0;

    hBack = new CBitmap("back.png");
    hKnob = new CBitmap("knob.png");
    hSaturate = new CBitmap("saturate.png");
    hSplash = new CBitmap("splash.png");
...
void H2Oeditor::valueChanged(CControl* control)
{
