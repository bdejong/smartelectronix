...
bool Multitap::SSEDetect()
{
    ...
    // All x64 CPUs support SSE
    return true;
#elif defined(_MSC_VER)
    // MSVC 32-bit: use structured exception handling to test SSE
    bool SSE = true;
    ...
    return SSE;
#else
    // Other 32-bit compilers: assume SSE is available on modern systems
    // Fallback to FPU is safe if SSE fails at runtime
    return true;
#endif
}
